...
namespace Cliente
{
    public class Reconstrucao
    {
        ...
        public static void IniciaReconstrucao(string g)
        {
            arquivoG = g;
            ...
            path = @"C:\Users\a1762680\Downloads\" + g + ".csv";
            ...
            ultravector = SoundGain(794, 64, Ultrasound);
            CriaImagem();
        }
        ...
        {
            Features.Reconstrucao.IniciaReconstrucao("G-2");
        }
    }
}